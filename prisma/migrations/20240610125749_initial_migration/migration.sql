...
-- AddForeignKey
ALTER TABLE "Transactions" ADD CONSTRAINT "Transactions_shipmentsId_fkey" FOREIGN KEY ("shipmentsId") REFERENCES "Shipments"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
